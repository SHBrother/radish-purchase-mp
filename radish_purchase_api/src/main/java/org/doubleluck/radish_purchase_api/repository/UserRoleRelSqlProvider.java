...
public class UserRoleRelSqlProvider {
     ...
     */
    public String countByExample(UserRoleRelExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_role_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String deleteByExample(UserRoleRelExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("user_role_rel");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String insertSelective(UserRoleRel record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_role_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String selectByExample(UserRoleRelExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserRoleRel record = (UserRoleRel) parameter.get("record");
        UserRoleRelExample example = (UserRoleRelExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("user_role_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String updateByPrimaryKeySelective(UserRoleRel record) {
        SQL sql = new SQL();
        sql.UPDATE("user_role_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    protected void applyWhere(SQL sql, UserRoleRelExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
