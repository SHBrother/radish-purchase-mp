...
public class SellerBuyerRelSqlProvider {
     ...
     */
    public String countByExample(SellerBuyerRelExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("seller_buyer_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String deleteByExample(SellerBuyerRelExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("seller_buyer_rel");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String insertSelective(SellerBuyerRel record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("seller_buyer_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String selectByExample(SellerBuyerRelExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SellerBuyerRel record = (SellerBuyerRel) parameter.get("record");
        SellerBuyerRelExample example = (SellerBuyerRelExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("seller_buyer_rel");
        ...
        if (record.getBuyerId() != null) {
            sql.SET("buyer_id = #{record.buyerId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String updateByPrimaryKeySelective(SellerBuyerRel record) {
        SQL sql = new SQL();
        sql.UPDATE("seller_buyer_rel");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    protected void applyWhere(SQL sql, SellerBuyerRelExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
