...
public class OrderStatusSqlProvider {
     ...
     */
    public String countByExample(OrderStatusExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String deleteByExample(OrderStatusExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("order_status");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    public String selectByExample(OrderStatusExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OrderStatus record = (OrderStatus) parameter.get("record");
        OrderStatusExample example = (OrderStatusExample) parameter.get("example");
     ...
     * @mbg.generated Mon Aug 27 15:04:52 CST 2018
     */
    protected void applyWhere(SQL sql, OrderStatusExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
